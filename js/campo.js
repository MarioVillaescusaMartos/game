...
function preload()
{
  ...
  this.load.spritesheet('enemyTauro', 'assets/enemies/volador.png', {frameWidth: 36, frameHeight: 50});
}
...
function create()
{
  ...
  //Enemigo prueba
  /*enemyTauro = this.physics.add.sprite(spawnPoint.x, spawnPoint.y + 100, "enemyTauro");
 ...
 this.physics.add.overlap(arrowList, enemyTauroList, destroyEnemy, null, this);
  ...
  this.physics.add.collider(Medio, enemyTauro1);
  this.physics.add.collider(EntreTop, enemyTauro1);
  this.physics.add.collider(Agua, enemyTauro1);
...
function enemyCreatorDown()
{
  enemyTauro = enemyTauroList.create(player.x, player.y + 100, "enemyTauro");
	enemyTauro.setOrigin(0.5, 0.5);
	enemyTauro.setScale(0.55, 0.55);
  enemyTauro.direccion = 0;
  enemyTauro.setSize(36,36);
...
function enemyDown()
{
  enemyTauro.anims.play('enemyDown', true);
